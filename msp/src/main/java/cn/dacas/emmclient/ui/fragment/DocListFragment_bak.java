...
import cn.dacas.emmclient.util.SimpleDateUtil;

/**
 * A placeholder fragment containing a simple view.
 */
public class DocListFragment_bak extends BaseFragment implements ControllerListener, SearchView.SearchViewListener {
...
//    FileOpener mFileOpener;
    ...
    public static Fragment newInstance(int sectionNumber) {
        DocListFragment_bak curFragment = new DocListFragment_bak();
...
//                refreshableView.finishRefreshing();
        ...
        this.getActivity().registerReceiver(mRefreshReceiver,
                new IntentFilter(DocListFragment_bak.ACTION_REFRESH_DOC));
