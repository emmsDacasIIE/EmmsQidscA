...
import cn.qdsc.msp.core.mdm.PolicyContent;
...
import cn.qdsc.msp.ui.activity.mainframe.AppDetailActivity;
...
public class AppListFragment extends BaseFragment implements SearchView.SearchViewListener {
    ...
    // 下载完成修改状态
    public static final String ACTION_REFRESH_APPSTORE = "cn.qdsc.msp.mam.REFRESH_APP_STORE";
