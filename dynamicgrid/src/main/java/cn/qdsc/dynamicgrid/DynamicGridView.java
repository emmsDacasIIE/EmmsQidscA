            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mHoverCell != null) {
                    ...
                    if (mPageChangedListener!=null) {
                        int dx=SCREEN_WIDTH/20;
                        if (mLastEventX<=dx)
                             mPageChangedListener.onLeftPage(getPositionForView(mMobileView));
                        if (mLastEventX>=SCREEN_WIDTH-dx) {
                             mPageChangedListener.onRightPage(getPositionForView(mMobileView));
                        }
                    }
                }
                break;
