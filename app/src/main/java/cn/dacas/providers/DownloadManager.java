...
import cn.dacas.providers.downloads.Downloads;
...
public class DownloadManager {
     ...
     * completes.
     */
    public final static String ACTION_DOWNLOAD_COMPLETE = "emmclient.intent.action.DOWNLOAD_COMPLETE";
     ...
     * downloads UI.
     */
    public final static String ACTION_NOTIFICATION_CLICKED = "emmclient.intent.action.DOWNLOAD_NOTIFICATION_CLICKED";

    /**
     * Intent action to launch an activity to display all downloads.
     */
    public final static String ACTION_VIEW_DOWNLOADS = "emmclient.intent.action.VIEW_DOWNLOADS";
