...
package cn.dacas.providers.downloads;
...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "cn.dacas.downloads";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "cn.dacas.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "cn.dacas.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "cn.dacas.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "cn.dacas.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "cn.dacas.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * @hide
     */
    public static final String ACTION_DOWNLOAD_COMPLETED = "emmclient.intent.action.DOWNLOAD_COMPLETED";
     ...
     * @hide
     */
    public static final String ACTION_NOTIFICATION_CLICKED = "emmclient.intent.action.DOWNLOAD_NOTIFICATION_CLICKED";
