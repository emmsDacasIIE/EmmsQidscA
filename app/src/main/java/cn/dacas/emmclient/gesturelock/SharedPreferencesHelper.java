...
public class SharedPreferencesHelper {
	...
	public final static int WORDS = 0;
	public final static int PATTERN = 1;
	private String PASSWORD_SETTING = "PASSWORDSETTING";
	...
	private SharedPreferences getSP() {
		return context.getSharedPreferences(PASSWORD_SETTING, Context.MODE_PRIVATE);
	}
