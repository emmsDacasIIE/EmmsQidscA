...
public class EmmClientDb {
	...
	private static final String DEVICEMSG_DATABASE_CREATE = "create table devicemsgtable (_id integer primary key autoincrement, "
			+ "msg text not null, time text not null);";
	private static final String CORPFILE_DATABASE_CREATE = "create table corpfiletable (_id integer primary key autoincrement, "
			+ "filetag text not null, isnative text not null, url text, path text, time text not null, sender text not null);";
...
//			onCreate(db);
	 ...
	 * @param mPassword 密码
	 */
	public void setWordsPassword(String mEmail, String mPassword,
								  String mUserName) {
        addDbItem(
				EmmClientDb.PASSWORD_DATABASE_TABLE,
				new String[]{"email", "name", "wordspwd", "patternpwd"},
				new String[]{
						mEmail,
						mUserName,
	...
	public String getWordsPassword(String mEmail) {
		Cursor mCursor = getItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
    ...
    public void setPatternPassword(String mEmail, String mPassword) {
        updateOrInsertItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
                new String[]{"email"}, new String[]{mEmail},
    ...
    public String getPatternPassword(String mEmail) {
        Cursor mCursor = getItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
                new String[] { "email" }, new String[] { mEmail },
    ...
    public boolean setLoginType(String mEmail, int mType) {
        return  updateOrInsertItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
                new String[]{"email"}, new String[]{mEmail},
                new String[]{"pwdtype"},
    ...
    public int getLoginType(String mEmail) {
        Cursor mCoursor = getItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
                new String[] { "email" }, new String[] { mEmail },
                new String[] { "pwdtype" });
    ...
    public boolean firstLogin(String mEmail) {
        Cursor mCoursor = getItemByInfo(EmmClientDb.PASSWORD_DATABASE_TABLE,
                new String[]{"email"}, new String[]{mEmail},
                new String[]{"name"});
        if (mCoursor == null)
